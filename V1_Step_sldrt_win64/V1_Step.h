...
#ifndef RTW_HEADER_V1_Step_h_
#define RTW_HEADER_V1_Step_h_
#include <string.h>
#ifndef V1_Step_COMMON_INCLUDES_
#define V1_Step_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* V1_Step_COMMON_INCLUDES_ */

#include "V1_Step_types.h"
...
#define V1_Step_rtModel                RT_MODEL_V1_Step_T
...
#define rtB                            V1_Step_B
#define BlockIO                        B_V1_Step_T
#define rtX                            V1_Step_X
#define ContinuousStates               X_V1_Step_T
#define rtXdot                         V1_Step_XDot
#define StateDerivatives               XDot_V1_Step_T
#define tXdis                          V1_Step_XDis
#define StateDisabled                  XDis_V1_Step_T
#define rtP                            V1_Step_P
#define Parameters                     P_V1_Step_T
#define rtDWork                        V1_Step_DW
#define D_Work                         DW_V1_Step_T

/* Parameters (default storage) */
struct P_V1_Step_T_ {
  real_T K_R;                          /* Variable: K_R
                                        * Referenced by: '<Root>/K_R'
                                        */
  real_T T_D;                          /* Variable: T_D
                                        * Referenced by: '<Root>/T_D'
                                        */
  real_T T_I;                          /* Variable: T_I
...
extern P_V1_Step_T V1_Step_P;

/* Block signals (default storage) */
extern B_V1_Step_T V1_Step_B;

/* Continuous states (default storage) */
extern X_V1_Step_T V1_Step_X;

/* Block states (default storage) */
extern DW_V1_Step_T V1_Step_DW;

/* Model entry point functions */
extern void V1_Step_initialize(void);
extern void V1_Step_output(void);
extern void V1_Step_update(void);
extern void V1_Step_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern V1_Step_rtModel *V1_Step(void);
...
extern RT_MODEL_V1_Step_T *const V1_Step_M;
